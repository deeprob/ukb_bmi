...
ls ${root_dir}/data/annotated_by_sample | while read i
do
	cat ${root_dir}/data/annotated_by_sample/$i/*/*.tsv >> ${root_dir}/data/variants/exonic_variants_high_impact_moderate_impact.tsv
done
