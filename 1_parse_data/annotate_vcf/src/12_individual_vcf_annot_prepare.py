...
if __name__=="__main__":
    ...
    for row in df.itertuples():
        ...
        in_vcf = f'/data5/UK_Biobank/annotations/vep/2022_02_27/vcfs/by_sample/{sample_name[-3:]}/{sample_name}.vcf.gz'
        out_vcf_pre = f'/data5/UK_Biobank/annotations/vep/2022_03_13/data/by_sample/{sample_name[-2:]}/{sample_name}'
