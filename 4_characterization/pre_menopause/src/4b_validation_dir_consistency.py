...
phenotype_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/non_white_british_pre_menopause/data/samples.csv"
...
save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/validation/dir_consistency.csv"
