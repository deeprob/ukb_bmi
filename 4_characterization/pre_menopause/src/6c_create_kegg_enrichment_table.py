...
if __name__ == "__main__":
    ...
    kegg_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/src/scripts/kegg_enrich.sh"
    save_dir = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/enrichment/kegg/"
    ...
    create_kegg_enrichment_table([combinations2_df, ], [2, ], kegg_bash_path, save_dir)
