...
if __name__ == "__main__":
    ...
    gsea_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/src/scripts/gsea_enrich.sh"
    save_dir = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/enrichment/go/"
    ...
    create_gsea_enrichment_table([combinations2_df, ], [2, ], gsea_bash_path, save_dir)
