...
phenotypes_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/non_white_british_pre_menopause/data/samples.csv"
...
single_hit_pheno, combo_hit_pheno, non_combo_hit_pheno = get_single_combo_phenos(variants_df, phenotypes_df, (combinations2_df, ), (2,))
...
save_table = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/validation/valid_mean.csv"
