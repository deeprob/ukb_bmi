...
efs_df = pd.concat([combo2_efs, akbari_efs, turcot_efs], axis=0)

save_table = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/effect_sizes/all.csv"
