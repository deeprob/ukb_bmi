...
phenotypes_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/pre_menopause/data/samples_with_residuals.csv"
...
oligo_df = pd.concat((single_hit_pheno_c2, combo_hit_pheno_c2), axis=0)
save_table = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/oligogenic/oligo_table.csv"
