...
def run_fishers_exact_in_r(contingency_table, fishers_bash_path, tmp_dir="/data5/deepro/tmp/prem"):
...
if __name__ == "__main__":
    ...
    fishers_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/src/scripts/fishers_exact.sh"
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/enrichment/gwas/gwas_enrichment.csv"
    ...
    stats = create_gwas_enrichment_table([combinations2_df], [2], gwas_df, genes, fishers_bash_path, save_file)