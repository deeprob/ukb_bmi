...
if __name__ == "__main__":
    ...
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/pre_menopause/data/enrichment/mgi/mgi_enrichment.csv"
    ...
    stats = create_mgi_enrichment_table([combinations2_df,], [2, ], mgi_df, genes, fishers_bash_path, save_file)
