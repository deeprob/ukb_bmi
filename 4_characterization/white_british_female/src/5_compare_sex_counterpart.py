...
phenotypes_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/white_british_male/data/samples.csv"
...
opp_sex_df = pd.concat((non_combo_hit_pheno, combo_hit_pheno), axis=0)
save_table = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_female/data/validation/opp_sex_mean.csv"
opp_sex_df.to_csv(save_table, index=False)
