...
if __name__ == "__main__":
    ...
    kegg_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_female/src/scripts/kegg_enrich.sh"
    save_dir = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_female/data/enrichment/kegg/"
