...
def run_fishers_exact_in_r(contingency_table, fishers_bash_path, tmp_dir="/data5/deepro/tmp/wbf"):
...
def create_gwas_enrichment_table(combo_dfs, ncombos_list, gwas_df, genes_study, fishers_bash_path, save_file):
    ...
    stats = pd.DataFrame(stats, columns=['gwas_phenotype', 'oddsratio', 'pvalue', 'conf_int_lower', 'conf_int_upper', 'Num_combo_genes_with_phenotype', 'Num_combo_genes_without_phenotype', 'Num_noncombo_genes_with_phenotype', 'Num_noncombo_genes_without_phenotype'])
...
if __name__ == "__main__":
    ...
    fishers_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_female/src/scripts/fishers_exact.sh"
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_female/data/enrichment/gwas/gwas_enrichment.csv"
    ...
    stats = create_gwas_enrichment_table([combinations2_df, combinations3_df], [2, 3], gwas_df, genes, fishers_bash_path, save_file)