...
for combo_num in combo_nums:
    ...
    statistics_file = f"/data5/deepro/ukbiobank/papers/bmi_project/3_run_rarecomb/post_menopause/data/parsed_tables/combo_{combo_num}.csv"
...
df.to_csv("/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/previous_associations/associations.csv", index=False)
