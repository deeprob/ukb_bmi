...
phdf = pd.read_csv("/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/post_menopause/data/samples_with_residuals.csv")
...
giant_effect_size_save = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/effect_sizes/giant.csv"
...
akbari_effect_size_save = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/effect_sizes/akbari.csv"
