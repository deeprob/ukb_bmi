...
def run_fishers_exact_in_r(contingency_table, fishers_bash_path, tmp_dir="/data5/deepro/tmp/mgi"):
...
if __name__ == "__main__":
    ...
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/enrichment/mgi/mgi_enrichment.csv"
