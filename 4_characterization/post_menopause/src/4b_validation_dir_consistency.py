...
phenotype_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/non_white_british_post_menopause/data/samples.csv"
...
save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/validation/dir_consistency.csv"
