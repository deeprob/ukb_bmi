...
if __name__ == "__main__":
    ...
    gsea_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/src/scripts/gsea_enrich.sh"
    save_dir = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/enrichment/go/"
