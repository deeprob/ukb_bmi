...
def run_fishers_exact_in_r(contingency_table, fishers_bash_path, tmp_dir="/data5/deepro/tmp/postm"):
...
if __name__ == "__main__":
    ...
    fishers_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/src/scripts/fishers_exact.sh"
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/post_menopause/data/enrichment/gwas/gwas_enrichment.csv"
