...
# ICD risk
risk_combo_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/obesity_related_diseases/data/merged_combos/risk_combos.csv"
risk_df = pd.read_csv(risk_combo_file)
risk_df.Phenotype = risk_df.Phenotype.astype(str)
# # obesity risk 
...
# meta_df = pd.concat([combo_df, risk_df])

icd_names = ['I10', 'E780', 'R074', 'I251', 'I259', 'E039', 'E11', 'BlockM15-M19', 'K80', 'K81', 'K82', 'F32', 'F33', 'G30']
group_names = icd_names #+ ["high_bmi"]
upset_df, unique_intersects = get_upset_df(risk_df, group_names)
upset_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/obesity_related_diseases/data/upset_files/risk.csv"
