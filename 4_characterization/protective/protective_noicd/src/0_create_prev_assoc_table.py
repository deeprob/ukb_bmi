...
for combo_num in combo_nums:
    ...
    statistics_file = f"/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/protective/protective_noicd/data/parsed_tables/combo_{combo_num}.csv"
...
df.to_csv("/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/protective/protective_noicd/data/previous_associations/associations.csv", index=False)
