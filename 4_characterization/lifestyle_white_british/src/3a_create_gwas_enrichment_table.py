...
if __name__ == "__main__":
    ...
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/lifestyle_white_british/data/enrichment/gwas/gwas_enrichment.csv"
    ...
    stats = create_gwas_enrichment_table([combinations3_df, combinations4_df], [3, 4], gwas_df, genes, fishers_bash_path, save_file)
