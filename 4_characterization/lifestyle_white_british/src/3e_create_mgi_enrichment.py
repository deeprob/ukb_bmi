...
if __name__ == "__main__":
    ...
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/lifestyle_white_british/data/enrichment/mgi/mgi_enrichment.csv"
    ...
    stats = create_mgi_enrichment_table([combinations4_df, combinations3_df], [4, 3], mgi_df, genes, fishers_bash_path, save_file)
