...
if __name__ == "__main__":
    ...
    fishers_bash_path = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_male/src/scripts/fishers_exact.sh"
    save_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_male/data/enrichment/gwas/gwas_enrichment.csv"
