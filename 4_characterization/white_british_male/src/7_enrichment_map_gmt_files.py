...
if __name__ == "__main__":
    ...
    input_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_male/data/enrichment/go/go_enrichment.csv"
    out_file = "/data5/deepro/ukbiobank/papers/bmi_project/4_characterization/white_british_male/data/enrichment/go/go_enrichment.gmt"
