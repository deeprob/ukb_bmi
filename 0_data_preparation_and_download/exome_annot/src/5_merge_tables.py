...
if __name__ == "__main__":
    chr_dir = "/data6/deepro/ukb_bmi/0_data_preparation_and_download/exome_annot/data/burden_tables"
    burden_dfs = []
    ...
    gtf_file = "/data6/deepro/ukb_bmi/0_data_preparation_and_download/exome_annot/data/gene_annotations/gencode.v44.basic.annotation.gtf"
    parsed_gtf_file = "/data6/deepro/ukb_bmi/0_data_preparation_and_download/exome_annot/data/gene_annotations/gencode.v44.basic.annotation.parsed.csv"
    save_file = "/data6/deepro/ukb_bmi/0_data_preparation_and_download/exome_annot/data/processed_burden/all_gene_burden.csv.gz"
