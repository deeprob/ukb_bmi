...
final_samples_file = "/data5/deepro/ukbiobank/papers/bmi_project/2_prepare_data_for_analysis/post_menopause/data/samples.csv"

phenotype_df = pd.read_csv(phenotypes_data)
# filter for white british female samples
phenotype_df = phenotype_df.loc[(phenotype_df.genetic_ethnic_grouping == 1)&(phenotype_df.genetic_sex == 0)&(phenotype_df.had_menopause == 'Yes')]
