...
# filter for white british female samples without menopause
phenotype_df = phenotype_df.loc[(phenotype_df.genetic_ethnic_grouping == 1)&(phenotype_df.genetic_sex == 0)&(phenotype_df.had_menopause == 'No')]
